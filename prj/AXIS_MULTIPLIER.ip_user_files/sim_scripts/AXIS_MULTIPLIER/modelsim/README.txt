...
#
# Generated by export_simulation on Tue Jan 14 15:48:22 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './AXIS_MULTIPLIER.sh' script.

./AXIS_MULTIPLIER.sh -reset_run
...
./AXIS_MULTIPLIER.sh -noclean_files

For more information on the script, please type './AXIS_MULTIPLIER.sh -help'.
