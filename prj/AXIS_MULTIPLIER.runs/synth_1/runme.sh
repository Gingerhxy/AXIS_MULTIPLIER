...
HD_PWD='D:/Code_repositories/fpga_code/AXIS_MULTIPLIER/prj/AXIS_MULTIPLIER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXIS_MULTIPLIER_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXIS_MULTIPLIER_wrapper.tcl
