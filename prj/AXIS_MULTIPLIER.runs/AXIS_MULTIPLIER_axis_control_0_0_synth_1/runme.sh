...
HD_PWD='D:/Code_repositories/fpga_code/AXIS_MULTIPLIER/prj/AXIS_MULTIPLIER.runs/AXIS_MULTIPLIER_axis_control_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXIS_MULTIPLIER_axis_control_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXIS_MULTIPLIER_axis_control_0_0.tcl
