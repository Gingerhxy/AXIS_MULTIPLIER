...
//Command     : generate_target AXIS_MULTIPLIER_wrapper.bd
//Design      : AXIS_MULTIPLIER_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module AXIS_MULTIPLIER_wrapper
   (clk_0,
    ...
    s_axis_b_0_tvalid);
  input clk_0;
  output [63:0]m_axis_result_0_tdata;
  ...
  wire clk_0;
  wire [63:0]m_axis_result_0_tdata;
  ...
  AXIS_MULTIPLIER AXIS_MULTIPLIER_i
       (.clk_0(clk_0),
