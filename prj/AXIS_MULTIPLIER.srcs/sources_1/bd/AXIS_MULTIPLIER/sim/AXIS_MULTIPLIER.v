...
//Date        : Tue Jan 14 15:48:19 2025
//Host        : DESKTOP-PNEHOBD running 64-bit major release  (build 9200)
//Command     : generate_target AXIS_MULTIPLIER.bd
//Design      : AXIS_MULTIPLIER
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "AXIS_MULTIPLIER,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=AXIS_MULTIPLIER,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "AXIS_MULTIPLIER.hwdef" *) 
module AXIS_MULTIPLIER
   (clk_0,
    ...
    s_axis_b_0_tready,
    s_axis_b_0_tvalid);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_0, ASSOCIATED_BUSIF s_axis_a_0:s_axis_b_0:m_axis_result_0, CLK_DOMAIN AXIS_MULTIPLIER_clk_0, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input clk_0;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_result_0 TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_result_0, CLK_DOMAIN AXIS_MULTIPLIER_clk_0, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [63:0]m_axis_result_0_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_a_0 TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_a_0, CLK_DOMAIN AXIS_MULTIPLIER_clk_0, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [31:0]s_axis_a_0_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_b_0 TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_b_0, CLK_DOMAIN AXIS_MULTIPLIER_clk_0, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [31:0]s_axis_b_0_tdata;
  ...
  wire [63:0]axis_control_0_m_axis_result_TDATA;
  ...
  assign m_axis_result_0_tdata[63:0] = axis_control_0_m_axis_result_TDATA;
  ...
  AXIS_MULTIPLIER_axis_control_0_0 axis_control_0
       (.A(axis_control_0_A),
        .B(axis_control_0_B),
        .S(mult_gen_0_P),
        .clk(clk_0_1),
  ...
  AXIS_MULTIPLIER_mult_gen_0_0 mult_gen_0
       (.A(axis_control_0_A),
        .B(axis_control_0_B),
        .P(mult_gen_0_P));
endmodule
